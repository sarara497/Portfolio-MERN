        ...
        <Slide right>
          <div id="about__content">
            <h4 className="about__disc">
              A graduate of Computer Science , I enrolled in this Specialty with
            ...
            <a
              href="https://drive.google.com/drive/folders/1nwq2Xzfku9kbelqeBs9lV-Odt1arHlRb?usp=sharing"
              target="blank"
              className="btnn"
            >
              My Resume
